package com.example.sns.exAdapter.movieApi2.DB;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void insertRecord(String mtitle, String mlink, String mimage, String msubtitle, String mpubDate, String mdirector, String mactor, String muserRating){
        ...
        database.execSQL("INSERT INTO movieTBL(title, link, image, subtitle, pubDate, director, actor, userRating)" +
                " VALUES('" + mtitle + "','" + mlink + "','" + mimage + "','" + msubtitle + "','"+ mpubDate + "','" + mdirector + "','" + mactor + "','" + muserRating + "');");

        Log.d("추가 : ", mtitle + "\t" + mlink + "\t" + mimage+ "\t" + msubtitle+ "\t" + mpubDate+ "\t" + mdirector + "\t" + mactor+ "\t" + muserRating);
    }


    public ArrayList<MovieData> movieQuery(){
        ...
        for (int i = 0; i < recordCount; i++){
            ...
            MovieData data = new MovieData(title, link, image, subtitle, pubDate, director, actor, userRating);
            result.add(data);
        }
        cursor.close();
