...
public class mv_watcha extends Fragment {

    private View view;
    private RecyclerView recyclerView_watcha;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.mv_fragment_watcha, container, false);

        recyclerView_watcha = view.findViewById(R.id.recycler_watcha);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 2);
        recyclerView_watcha.setLayoutManager(gridLayoutManager);
        ...
        recyclerView_watcha.setAdapter(adapter);
