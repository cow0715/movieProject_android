...
public class mv_tving extends Fragment {

    private View view;
    private RecyclerView recyclerView_tving;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.mv_fragment_tving, container, false);

        recyclerView_tving = view.findViewById(R.id.recycler_tving);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 2);
        recyclerView_tving.setLayoutManager(gridLayoutManager);
        ...
        recyclerView_tving.setAdapter(adapter);
